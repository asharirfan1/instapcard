...
class HomeController extends AppBaseController
{
    ...
    /**
     * Example method to display NFC cards on a separate page.
     */
    public function showNfcCards()
    {
        // Fetch NFC cards from the database
        $nfcCards = Nfc::all();
        
        // Pass the NFC cards data to the view
        return view('front.home.nfc-cards', compact('nfcCards'));
    }
